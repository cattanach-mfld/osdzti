...
#Start-OSDCloudMFLD -OSVersion 'Windows 11' -OSLanguage en-us -OSBuild 21H2 -OSEdition Education -Firmware -ZTI
Start-OSDCloudMFLD -OSVersion 'Windows 10' -OSLanguage en-us -OSBuild 21H2 -OSEdition Education -Firmware -ZTI
#Start-OSDCloudGUI
